 ...
 *
 * @package Event Organizer Tools \ Taxonomy
 * @author Carl Alberto
 * @since 1.0.0
 */
 ...
 * Main taxonomy class.
 */
class Event_Organizer_Tools_Taxonomy {
	...
	public function register_taxonomy() {
		$labels = array(
			...
			'update_item' => sprintf( __( 'Update %s' , 'event-organizer-tools' ), $this->single ),
			'add_new_item' => sprintf( __( 'Add New %s' , 'event-organizer-tools' ), $this->single ),
			'new_item_name' => sprintf( __( 'New %s Name' , 'event-organizer-tools' ), $this->single ),
			'parent_item' => sprintf( __( 'Parent %s' , 'event-organizer-tools' ), $this->single ),
			'parent_item_colon' => sprintf( __( 'Parent %s:' , 'event-organizer-tools' ), $this->single ),
			'search_items' => sprintf( __( 'Search %s' , 'event-organizer-tools' ), $this->plural ),
			'popular_items' => sprintf( __( 'Popular %s' , 'event-organizer-tools' ), $this->plural ),
			'separate_items_with_commas' => sprintf( __( 'Separate %s with commas' , 'event-organizer-tools' ), $this->plural ),
			'add_or_remove_items' => sprintf( __( 'Add or remove %s' , 'event-organizer-tools' ), $this->plural ),
			'choose_from_most_used' => sprintf( __( 'Choose from the most used %s' , 'event-organizer-tools' ), $this->plural ),
