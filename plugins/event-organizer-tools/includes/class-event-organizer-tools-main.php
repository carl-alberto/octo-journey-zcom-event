 ...
 *
 * @package Event Organizer Tools \ Main Functionalities
 * @author Carl Alberto
 * @since 1.0.0
 */
 ...
 */
class Event_Organizer_Tools_Main {
	/**
	...
	public function register_post_type( $post_type = '', $plural = '', $single = '', $description = '', $options = array() ) {
		...
		$post_type = new Event_Organizer_Tools_Post_Type( $post_type, $plural, $single, $description, $options );
	...
	public function register_taxonomy( $taxonomy = '', $plural = '', $single = '', $post_types = array(), $taxonomy_args = array() ) {
		...
		$taxonomy = new Event_Organizer_Tools_Taxonomy( $taxonomy, $plural, $single, $post_types, $taxonomy_args );
