...
class Optin_Popup_Box {
	...
	public function __construct( $file = '', $version = '1.0.0', $pluginoptions = array() ) {
		...
		if ( is_admin() ) {
			$this->admin = new Optin_Popup_Box_Admin_API();
		}
// @codingStandardsIgnoreFile
//		$custom = new Optin_Popup_Box_Main;
...
//		$custom->register_cpt1();
	...
	/**
	 * The single instance of Optin_Popup_Box.
	 *
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	...
	public function load_localisation() {
		load_plugin_textdomain( 'optin-popup-box', false, dirname( plugin_basename( $this->file ) ) . '/languages/' );
	...
	/**
	 * Main Optin_Popup_Box Instance.
	 *
	 * Ensures only one instance of Optin_Popup_Box is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see Optin_Popup_Box()
	 ...
	 * @param string $version Version of this plugin.
	 * @param array  $pluginoptions Contains various options for the plugin.
	 * @return Main Optin_Popup_Box instance
	 */
