...
Installing "Simple Event Directory" can be done either by searching for "Simple Event Directory" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
