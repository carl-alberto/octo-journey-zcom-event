...
Installing "Pagespeed Site Optimize" can be done either by searching for "Pagespeed Site Optimize" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
