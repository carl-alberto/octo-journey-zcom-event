 ...
 *
 * @package Simple Event Directory \ Admin API
 * @author Carl Alberto
 * @since 1.0.0
 */
 ...
 */
class Simple_Event_Directory_Admin_API {
	...
	public function display_field( $data = array(), $post = false, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image' , 'simple-event-directory' ) . '" data-uploader_button_text="' . __( 'Use image' , 'simple-event-directory' ) . '" class="image_upload_button button" value="' . __( 'Upload new image' , 'simple-event-directory' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image' , 'simple-event-directory' ) . '" />' . "\n";
