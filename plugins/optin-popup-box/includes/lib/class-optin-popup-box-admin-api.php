 ...
 *
 * @package Optin Popup Box \ Admin API
 * @author Carl Alberto
 * @since 1.0.0
 */
 ...
 */
class Optin_Popup_Box_Admin_API {
	...
	public function display_field( $data = array(), $post = false, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image' , 'optin-popup-box' ) . '" data-uploader_button_text="' . __( 'Use image' , 'optin-popup-box' ) . '" class="image_upload_button button" value="' . __( 'Upload new image' , 'optin-popup-box' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image' , 'optin-popup-box' ) . '" />' . "\n";
