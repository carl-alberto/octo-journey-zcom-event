 ...
 *
 * @package Pagespeed Site Optimize \ Admin API
 * @author Carl Alberto
 * @since 1.0.0
 */
 ...
 */
class Pagespeed_Site_Optimize_Admin_API {
	...
	public function display_field( $data = array(), $post = false, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image' , 'pagespeed-site-optimize' ) . '" data-uploader_button_text="' . __( 'Use image' , 'pagespeed-site-optimize' ) . '" class="image_upload_button button" value="' . __( 'Upload new image' , 'pagespeed-site-optimize' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image' , 'pagespeed-site-optimize' ) . '" />' . "\n";
