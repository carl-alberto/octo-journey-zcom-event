...
Installing "Optin Popup Box" can be done either by searching for "Optin Popup Box" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
