 ...
 *
 * @package Optin Popup Box \ Main Functionalities
 * @author Carl Alberto
 * @since 1.0.0
 */
...
class Optin_Popup_Box_Main {
	...
	public function register_post_type( $post_type = '', $plural = '', $single = '', $description = '', $options = array() ) {
		...
		$post_type = new Optin_Popup_Box_Post_Type( $post_type, $plural, $single, $description, $options );
	...
	public function register_taxonomy( $taxonomy = '', $plural = '', $single = '', $post_types = array(), $taxonomy_args = array() ) {
		...
		$taxonomy = new Optin_Popup_Box_Taxonomy( $taxonomy, $plural, $single, $post_types, $taxonomy_args );
